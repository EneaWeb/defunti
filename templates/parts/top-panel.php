            ...
            <div class="logo">
                <div class="logo_img">
                    <a href="<?php _e(esc_url(home_url())); ?>">
                        <?php _e(!empty($ANCORA_GLOBALS['logo_'.($logo_style)]) ? '<img src="'.esc_url($ANCORA_GLOBALS['logo_'.($logo_style)]).'" class="logo_main" alt=""><img src="'.esc_url($ANCORA_GLOBALS['logo_fixed']).'" class="logo_fixed" alt=""></a></div><div class="contein_logo_text"><a href="' . home_url().'">' : ''); ?><?php  _e($ANCORA_GLOBALS['logo_text'] ? '<span class="logo_text">'.($ANCORA_GLOBALS['logo_text']).'</span>' : ''); ?><?php _e($ANCORA_GLOBALS['logo_slogan'] ? '<span class="logo_slogan">' . esc_html($ANCORA_GLOBALS['logo_slogan']) . '</span></a></div>' : ''); ?>
                </div>
                <a href="#" class="menu_main_responsive_button icon-menu-1"></a>
                <div class="inline image side-right marg_top_2em">
                    <div class="inline">
                        <img src="<?php _e(ancora_get_file_url('skins/'.($theme_skin).'/images/phone.jpg')); ?>" alt="">
                    ...
                    <div class="inline pad_left_2em">
                        <img src="<?php _e(ancora_get_file_url('skins/'.($theme_skin).'/images/flower.jpg')); ?>" alt="">
                        <div class="side-right marg_null marg_top">
