...
<head>
	...
	<?php if (isset($_GET['custom_textarea'])) : ?>
		<script>
		jQuery(document).ready(function(){
			var contenuto = '<?php echo $_GET['custom_textarea'];?>';
			jQuery('.custom_textarea').html(contenuto);
		})
		</script>
	<?php endif; ?>
	<style>
