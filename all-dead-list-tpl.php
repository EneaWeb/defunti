<?php
/**
Template Name: All Dead Man List
 */
...
$user_count = $wpdb->get_var( "SELECT COUNT(*) FROM $wpdb->users AS wu,$wpdb->usermeta AS wum
	WHERE wu.ID=wum.user_id AND wum.meta_key='utype' AND wum.meta_value='dead_man'" );
?>
<link rel="stylesheet" href="<?php echo get_template_directory_uri()?>/dist/css/lightbox.min.css">
<div class="item-list-tabs" role="navigation">
			<ul>
				<li class="selected" id="members-all"><a href="#;"><?php printf( __( 'All Dead Members %s', 'buddypress' ), '<span>' . $user_count . '</span>' ); ?></a></li>
